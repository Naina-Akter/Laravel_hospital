@extends('layouts.app')
@section('page')
    <div class="card shadow-lg border border-dark mx-4 mt-4 card-default">
        <h2 class="py-2 bg-dark text-center text-light">Edit Department</h2>
            ...
            <form action="{{ route('departments.update', $dept->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option selected>{{ old('status', $dept->status == 0 ? 'active' : 'inactive') }}</option>
