                        ...
                        <div class="card-header pb-0">
                            <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                                <a class="w-auto pl-0" href="/index.html">
                                    ...
                                    <span class="brand-name text-dark">Hospital</span>
                                </a>
                            </div>
                        </div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12 mb-4">
                                        <input type="email" name="email" value="sadid@gmail.com" class="form-control input-lg" id="email"
                                            aria-describedby="emailHelp" placeholder="email">
                                    </div>
                                    <div class="form-group col-md-12 ">
                                        <input type="password" name="password" value="admin123" class="form-control input-lg"
